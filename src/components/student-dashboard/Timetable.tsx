...
export function Timetable({ lectures }: TimetableProps) {
  return (
    <Card title="Today's Schedule" className="lg:col-span-2">
      {lectures.length === 0 ? (
        <p className="mt-4 text-sm text-gray-500 transition-colors duration-300 dark:text-gray-300">
            ...
            >
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 inline-flex items-center gap-1 text-sm text-gray-500 transition-colors duration-300 dark:text-gray-300">
              ...
              {lecture.isHighlighted && (
                <p className="mt-3 text-xs font-semibold uppercase tracking-[0.12em] text-blue-700 transition-colors duration-300 dark:text-blue-300">
                  Next Lecture
                </p>
              )}
            </article>
