...
export default function SignupInstitutionPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      window.localStorage.removeItem(SIGNUP_STUDENT_DETAILS_STORAGE_KEY);      window.localStorage.removeItem(SIGNUP_LECTURER_DETAILS_STORAGE_KEY);      window.dispatchEvent(new Event(SIGNUP_INSTITUTION_UPDATED_EVENT));
    } catch {
