...
export function AuthLayout({ children, title, subtitle }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:w-[500px] xl:w-[600px] lg:px-12 xl:px-24 py-12">
      ...
      {/* Right pane - Image */}
      <div className="hidden lg:block relative w-0 flex-1 bg-[#0a0f5c]">
        ...
        <img
          ...
          alt="Library"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#0a0f5c] via-[#0a0f5c]/40 to-transparent" />
        
        <div className="absolute bottom-16 left-16 right-16 text-white max-w-2xl animate-slide-up delay-200">
          <div className="mb-6 flex gap-2">
            {[1, 2, 3, 4, 5].map((s) => (
              <svg key={s} className="w-6 h-6 text-yellow-400 fill-current" viewBox="0 0 20 20">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#2dd4a8] font-medium">Computer Science, Senior</p>
            </div>
          </div>
        </div>
      </div>
